...
#define ACURITE_MSGTYPE_ATLAS_UNKNOWN_1                 0x25
#define ACURITE_MSGTYPE_ATLAS_UNKNOWN_2                 0x26
#define ACURITE_MSGTYPE_ATLAS_UNKNOWN_3                 0x27
...
static int acurite_txr_decode(r_device *decoder, bitbuffer_t *bitbuffer)
{
    ...
    for (uint16_t brow = 0; brow < bitbuffer->num_rows; ++brow) {
        ...
        // The 5-n-1 weather sensor messages are 8 bytes.
            ...
            if (message_type == ACURITE_MSGTYPE_ATLAS_UNKNOWN_1) {
                // Wind speed, temperature and humidity
